...
import { z } from "zod";
import { formSchema } from "../QuestionForm/schema";
...
interface QuestionFormDefaultProps {
  moduleId: string;
  data: Session | null;
  setIsOpenDialog: React.Dispatch<React.SetStateAction<boolean>>;
}

function QuestionFormDefault({
  data,
  moduleId,
  setIsOpenDialog,
}: QuestionFormDefaultProps) {
...
export default QuestionFormDefault;
